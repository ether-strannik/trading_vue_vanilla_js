// (hammerjs stripped — zero-dep; native Y-axis drag-zoom is wired in the engine shell)
...
export default class Sidebar {
    ...
    // Y-axis drag-zoom was Hammer-based; stripped for zero-dep. The engine shell wires native
    // pointer events and calls calc_zoom/calc_range below, emitting 'sidebar-transform' itself.
